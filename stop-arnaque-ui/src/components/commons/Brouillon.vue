<!-- redirigé vers « Sign in » avec un message de succès, le test est en succès -->
        ...
        <div class="row justify-content-center align-items-center">
            ...
            <form novalidate @submit.prevent="onSubmit" class="col-md-5">
                <div class="mb-3">
                    ...
                    <input v-model.trim="state.user.email" name="email" id="email" type="email" class="form-control"
                        :class="{ 'is-invalid': v$.user.email.$error }" aria-describedby="emailHelp" />
